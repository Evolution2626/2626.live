...
matchesreq.onreadystatechange = function() {
  if (this.readyState == 4 && this.status == 200) {
    ...
    for (var i = 0; i < matchesresp.length; i++) {
      ...
      suggestedvids.innerHTML += '<div class="mdl-cell mdl-cell--2-col"><p><a href="archives.html?t=' + team + '&amp;e=' + eventid + '&amp;m=' + suggestedmid + '&amp;ap=1"><img src="https://i.ytimg.com/vi/' + suggestedmvid + '/hqdefault.jpg" alt="" width="100%" /></a></p><h4 style="text-align: center;">' + svrealtitle + '</h4></div>';
    }
  }
};
